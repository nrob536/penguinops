...
authors: [your-name]
tags: [data-science, wellbeing, decision-making, social investment]
---
...
## Introduction
Talks about societal progress oftens defaults to meassuring productivity, growth, economic metrics such as GDP.
However, these numbers only tell us partial view of the whole picture.
