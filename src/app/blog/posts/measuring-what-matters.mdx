...
image: "/images/projects/project-01/ianz-project.jpg"
---

## Disclaimer: The views expressed in this post are my own and do not necessarily represent those of Stats NZ 
or any other government agency.


## Introduction
When we talk about progress, we often default to economic metrics — GDP, productivity, growth.
Yet, these numbers only tell part of the story.
Working on Ngā Tūtohu Aotearoa – Indicators Aotearoa New Zealand (IANZ) reminded me that true
progress needs to include wellbeing.
...
From my experience contributing to this project, I saw how data can help translate complex ideas of wellbeing
...
As part of the team supporting the IANZ platform, my work focused on data integration, dashboard development, 
and analytical consistency. I helped bring together datasets from multiple sources, designing ways to visualise 
and communicate complex relationships between wellbeing indicators.

Working across these data systems revealed how interconnected wellbeing truly is.
...
Transforming wellbeing data into meaningful insight required both technical and conceptual innovation.
Three lessons stood out to me:

1. Context Matters

Indicators gain meaning only when grounded in the lived experience of people and places.
